...
ARG NEXT_PUBLIC_PLEX_ENABLED="false"
ARG NEXT_PUBLIC_AZTECO_ENABLED="false"
ENV API_URL=$API_URL
ENV NEXT_PUBLIC_SHOP_NAME=$NEXT_PUBLIC_SHOP_NAME
ENV NEXT_PUBLIC_SHOP_DISCORD_URL=$NEXT_PUBLIC_SHOP_DISCORD_URL
ENV NEXT_PUBLIC_PLEX_ENABLED=$NEXT_PUBLIC_PLEX_ENABLED
ENV NEXT_PUBLIC_AZTECO_ENABLED=$NEXT_PUBLIC_AZTECO_ENABLED
